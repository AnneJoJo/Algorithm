# TOP-DOWN with memo
# The tricky part is think from the end case of all nodes get marked:
# if we have 4 nodes then, it's 1111.
# we start from the final status and recursively check previous status
#
